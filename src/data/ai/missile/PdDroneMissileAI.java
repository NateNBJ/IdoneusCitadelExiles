...
public class PdDroneMissileAI extends BaseMissileAI {
    static final String WEAPON_ID = "sun_ice_hexac";
    static final String MISSILE_ID = "sun_ice_pddrone";
    static final float WEAPON_RANGE = 300f;
